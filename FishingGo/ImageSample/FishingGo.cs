...
namespace ImageSample
{
    ...
    class ImageSample : NUIApplication
    {
        ...
        private static string mPixelAreaImageUrl = mResourceUrl + "/nol.png";
        // SVG Image Url
        private static string mSVGImageUrl = mResourceUrl + "/gwang.png";
        // GIF Image Url
        private static string mGIFImageUrl = mResourceUrl + "/woo.png";
        // Nine patch Image Url
        private static string mNinePatchImageUrl = mResourceUrl + "/dol.png";
        // Mask Image Url
        private static string mMaskImageUrl = mResourceUrl + "/";
        // Mask background Image Url
        private static string mMaskBackgroundImageUrl = mResourceUrl + "/gam.png";
        // Image Url for the FittingMode
        private static string mFittingModeImageUrl = mResourceUrl + "/soong.png";
        private static string mImageUrl = mResourceUrl + "/go.png";
        private static string mImageUrl1 = mResourceUrl + "/sam.png";
        private static string mImageUrl2 = mResourceUrl + "/bol.png";
        private static string mImageUrl3 = mResourceUrl + "/bang.png";
        ...
        public void Initialize()
        {
            ...
            TextLabel title = new TextLabel("³¬½Ãµµ°¨");
        ...
        private View CreateImage(string text, Position position)
        {
            ...
            {
                TableView pixelAreaTableView = new TableView(0, 0);
            ...
            else if (text == mCaseString[6])
            {
                //Create an imageView to show the GIF file.
                ImageView imageView = new ImageView(mImageUrl);
                view = imageView;
            }
            else if (text == mCaseString[7])
            {
                //Create an imageView to show the GIF file.
                ImageView imageView = new ImageView(mImageUrl1);
                view = imageView;
            }
            else if (text == mCaseString[8])
            {
                //Create an imageView to show the GIF file.
                ImageView imageView = new ImageView(mImageUrl2);
                view = imageView;
            }
            else if (text == mCaseString[9])
            {
                //Create an imageView to show the GIF file.
                ImageView imageView = new ImageView(mImageUrl3);
                view = imageView;
            }
